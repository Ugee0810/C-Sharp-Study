...
namespace Ch02
{
    internal class _3_Operator
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"num : {num}"); // (문자열 보간 출력) -> 5
            ...
            bool rs4 = var1 <= var2; // var1이 var2보다 직거나 같다.
            bool rs5 = var1 != var2; // var1과 var2는 서로 다르다.
            ...
            // 논리 연산자(논리 게이트 AND, OR, NOT, NOT OR)
            int val1 = 1;
            int val2 = 2;

            bool res1 = var1 > 1 && var2 > 2; // AND - var1이 1보다 크고 그리고 var2는 2보다 크다.
            bool res2 = var1 > 0 && var2 > 1; // AND - var1이 0보다 크고 그리고 var2는 1보다 크다.

            bool res3 = var1 > 1 || var2 > 2; // OR - var1이 1보다 크고 또는 var2는 2보다 크다.
            bool res4 = var1 > 0 || var2 > 2; // OR - var1이 0보다 크고 또는 var2는 2보다 크다.
            bool res5 = var1 > 0 || var2 > 1; // OR - var1이 0보다 크고 또는 var2는 1보다 크다.

            bool res6 = !(var1 > var2); // NOT - var1이 var2 보다 크지 않다.
