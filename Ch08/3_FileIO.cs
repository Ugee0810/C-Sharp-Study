...
namespace Ch08
{
    internal class _3_FileIO
    {
        static void Main1(string[] args)
        {
            ...
            //파일 입력(Read)//
            //////////////////
            string path1 = "C:\\Users\\1302\\Desktop\\Sample1.txt"; // 파일 디렉토리(경로) 지정
            ...
            try
            {
                ...
                //파일 읽기
                string line;
                while ((line = sr.ReadLine()) != null) // 한 줄씩 반복
                {
            ...
            // 파일 읽기/쓰기
            string f1 = "C:\\Users\\1302\\Desktop\\Sample1.txt"; // Read
            string f3 = "C:\\Users\\1302\\Desktop\\Sample3.txt"; // Write

            try
            {
                //using 스트림 선언으로 스트림 자원 해제 자동 실행
                //FileStream(디렉토리 변수, 실행or생성)
